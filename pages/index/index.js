...
wx.getLocation({
  ...
  locationCorrect: function (latitude, longitude) {
    ...
    var params = {
      ...
      ak: "GviweL1vZxSlnZetD59rcgimMH3LDxRq" //百度网页端服务 AK
  }
//调用微信访问 url 方法
wx.request({
    url: url,
    ...
    success: function (res) {
      ...
      var badulon = res.data.result[0].x; that.getCity(badulat, badulon);//进入到经纬度转换城市方法
    },
      fail: function (res) { },
  ...
  getCity: function (latitude, longitude) {
    ...
    var params = {
      ak: "GviweL1vZxSlnZetD59rcgimMH3LDxRq",//百度网页端服务 AK(貌似微信小程序 AK 也行) 
      output: "json",
  ...
  getWeahter: function (city) {
    ...
    var params = {
      location: city,
      output: "json",
      ak: "50PdR5tAq9xmcuTaodpdsfbRL02QcKGc"//百度微信小程序 AK 
      }
wx.request({
        url: url,
        data: params,
